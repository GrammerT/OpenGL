...
OpenglOffscreenSurface::OpenglOffscreenSurface(QScreen *targetScreen , const QSize &size)
...
}  // OpenGlOffscreenSurface::grabFramebuffe
...
void OpenglOffscreenSurface::resize(int w, int h)
{
    resize(QSize(w,h));
}
...
void OpenglOffscreenSurface::initializeInternal()
{
    if(!m_initialized.exchange(true))
    {
        ...
        else
        {
            ...
            delete m_context;
            m_context = NULL;
            throw("failure to create OpenGL Context...");
        }
